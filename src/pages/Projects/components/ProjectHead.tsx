    ...
    <section ref={containerRef} className="w-full px-5 md:px-10 lg:px-20 overflow-hidden">
      <div className="max-w-350 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          >
            <img src={Background} alt="" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
          ...
          <div className="lg:col-span-5 flex flex-col gap-8 h-full">
            ...
            >
              <img src={HeadImage1} alt="" className="w-full h-full object-cover" />
            </motion.div>
            ...
            >
              <img src={HeadImage2} alt="" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" />
              {/* Overlay Badge */}
