    ...
    return (
        <>
            <Helmet>
                ...
                <meta property="og:title" content={`${service.title} | Nadjitan Betan`} />
                <meta property="og:description" content={service.description} />
                <meta property="og:image" content={service.image} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`https://nadjitan-betan.dayal-enterprises.com/services/details/${service.id}`} />
            </Helmet>
