            ...
            <header className="w-full h-20 md:h-24 px-6 md:px-15 relative z-50">
                <div className="w-full h-full flex items-center justify-between">
                    ...
                    <div className="hidden lg:flex items-center gap-8">
                        ...
                        <div className="flex items-center gap-3">
                            <Button className="w-10 h-10 rounded-full flex items-center justify-center border border-gray-200 hover:bg-black hover:text-white transition-colors">
                                <FiLogIn size={18} />
                            </Button>
                            <Button className="px-6 py-2 rounded-full bg-black text-white text-sm font-semibold border border-black hover:bg-transparent hover:text-black transition-all">
                                S'inscrire
                            </Button>
                        </div>
                    </div>
                ...
                <div className={`fixed top-0 right-0 w-[75%] max-w-xs h-screen bg-white shadow-2xl z-50 transition-transform duration-500 ease-in-out lg:hidden p-8 ${
                    ...
                    <div className="mt-10 flex flex-col gap-3">
                        <Button className="w-full py-4 rounded-2xl border border-gray-200 font-bold flex items-center justify-center gap-2">
                            <FiLogIn /> Connexion
                        </Button>
                        <Button className="w-full py-4 rounded-2xl bg-black text-white font-bold">
                            S'inscrire
                        </Button>
                    </div>
                </div>
