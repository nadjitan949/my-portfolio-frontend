...
function NotFound() {
  return (
    <>
      <Helmet>
        <title>Oups ! Mauvaise route</title>
        <meta name="description" content="Oups ! La page que vous recherchez n'existe pas ou a été déplacée. Revenez à l'accueil pour découvrir mon portfolio." />
        <meta property="og:title" content="Page Introuvable (404) | Nadjitan Betan" />
        <meta property="og:description" content="Oups ! Mauvaise route. La page demandée est introuvable." />
        <meta name="robots" content="noindex, follow" /> {/* Indique à Google de ne pas indexer cette page d'erreur */}
      </Helmet>
